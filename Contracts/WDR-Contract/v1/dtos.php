...
/*
* Contains arguments for calling 'GetWorkflowDefintion'.
*/
public class GetWorkflowDefintionRequest {
  
  // Required Argument for 'GetWorkflowDefintion' (string)
  #[Required]
...
/*
* Contains results from calling 'GetWorkflowDefintion'.
*/
public class GetWorkflowDefintionResponse {
  
  // This field contains error text equivalent to an Exception message! (note that only 'fault' XOR 'return' can have a value != null)
  public string $fault = null;
  
  // Return-Value of 'GetWorkflowDefintion' (ResearchStudyDefinition)
  public ResearchStudyDefinition $return;
